   ...
   <div className="container m-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 ">
    <div className="grid gap-4">
      {/* City Name container - 1st grid */}
        <div className="tile grid md:grid-cols-2 bg-teal-500  rounded-md p-6">
        <div className="tile bg-amber-500 rounded-md p-6">
          ...
          <div className="tile bg-teal-500 sm:col-span-1 md:col-span-1 p-4">
           <p>⛅ Image will go here!🌞</p>
          </div>
          
        </div>
        {/* Today's Forecast container -2nd grid */}
        <div className="tile bg-amber-500 rounded-md p-4">
          ...
          {/* <div className="grid grid-cols-3 divide-x-3 divide-dashed divide-indigo-500"> */}
            <ul className="grid grid-cols-5 divide-x-3 divide-solid divide-indigo-500">
        ...
        {/* 7-day forecast goes here  - 4th Grid to the Right */}
  ...
  <li className="flex justify-between gap-x-6 py-5">
    <div className="flex min-w-0 gap-x-4">
      <div className="min-w-0 flex-auto">
        <p className="text-sm/6 font-semibold text-gray-900">Today</p>
      </div>
    </div>
    <div className="flex min-w-0 gap-x-4">
      <div className="min-w-0 flex-auto">
        <p className="text-sm/6 font-semibold text-gray-900">Sunny</p>
      </div>
    </div>
    <div className=" sm:flex sm:flex-col sm:items-end">
    <p className="text-sm/6 font-semibold text-gray-900">High/Low</p>
  </div>
